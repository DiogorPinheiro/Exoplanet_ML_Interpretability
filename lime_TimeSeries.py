...
#  Adapted from Lime For Time (https://github.com/emanuel-metzenthin/Lime-For-Time) by Jonas Hering, Emanuel Metzenthin and Alexander Zenner
#  Based on Lime (https://github.com/marcotcr/lime) by Marco Tulio Ribeiro, Sameer Singh and Carlos Guestrin
...
class LimeTimeSeriesExplanation(object):
    ...
    def explain_instance(self,
       ...
       """
        ...
        ret_exp.local_exp = {k: [(int(j1), float(j2)) for j1, j2 in v]
